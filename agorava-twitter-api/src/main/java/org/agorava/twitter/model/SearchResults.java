...
/**
 * Represents the results of a Twitter search, including matching {@link Tweet}s and any metadata associated with that search.
 *
 * @author Craig Walls
...
public class SearchResults {
    ...
    /**
     * Returns <code>true</code> if this is the last page of matching {@link Tweet}s; <code>false</code> if there are more pages
