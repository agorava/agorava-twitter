...
abstract class DirectMessageMixin {
    @JsonCreator
    DirectMessageMixin(@JsonProperty("id") long id, @JsonProperty("text") String text,
            @JsonProperty("sender") TwitterProfile sender, @JsonProperty("recipient") TwitterProfile receipient,
